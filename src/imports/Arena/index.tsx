...
function Container11() {
  return (
    <div className="no-scrollbar content-stretch flex gap-[8px] items-center relative shrink-0 w-[380px] overflow-x-auto snap-x snap-mandatory" data-name="Container">
      <div className="content-stretch flex gap-[4px] min-h-[34px] items-center justify-center max-w-[200px] px-[16px] py-[8px] relative rounded-[16px] shrink-0 w-[101px] snap-start" style={{ backgroundImage: "linear-gradient(179.412deg, rgba(255, 148, 87, 0.8) 1.596%, rgba(153, 56, 0, 0.8) 98.637%), linear-gradient(90deg, rgb(14, 25, 45) 0%, rgb(14, 25, 45) 100%)" }} data-name="Tabs New - Sports">
        <div aria-hidden className="absolute border border-[#e5eafa] border-solid inset-0 pointer-events-none rounded-[16px]" />
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] min-w-px not-italic relative text-[#e5eafa] text-[14px] text-center whitespace-normal">
          <p className="leading-[18px]">Top League (45)</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[4px] min-h-[34px] items-center justify-center max-w-[200px] px-[16px] py-[8px] relative rounded-[16px] shrink-0 w-[101px] snap-start" style={{ backgroundImage: "url(\"data:image/svg+xml;utf8,<svg viewBox='0 0 101 34' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none'><rect x='0' y='0' height='100%' width='100%' fill='url(%23grad)' opacity='1'/><defs><radialGradient id='grad' gradientUnits='userSpaceOnUse' cx='0' cy='0' r='10' gradientTransform='matrix(6.4343e-14 3.4086 -12.286 1.8923e-13 50.5 -7.776e-13)'><stop stop-color='rgba(229,234,250,0.2)' offset='0'/><stop stop-color='rgba(229,234,250,0)' offset='0.3'/><stop stop-color='rgba(7,13,24,0)' offset='0.6'/><stop stop-color='rgba(7,13,24,0.5)' offset='1'/></radialGradient></defs></svg>\"), linear-gradient(90deg, rgb(14, 25, 45) 0%, rgb(14, 25, 45) 100%)" }} data-name="Tabs New - Sports">
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] min-w-px not-italic relative text-[#acafbb] text-[14px] text-center whitespace-normal">
      ...
      <div className="content-stretch flex flex-1 gap-[4px] min-h-[34px] items-center justify-center max-w-[200px] min-w-[101px] px-[16px] py-[8px] relative rounded-[16px] snap-start" style={{ backgroundImage: "url(\"data:image/svg+xml;utf8,<svg viewBox='0 0 101 34' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='none'><rect x='0' y='0' height='100%' width='100%' fill='url(%23grad)' opacity='1'/><defs><radialGradient id='grad' gradientUnits='userSpaceOnUse' cx='0' cy='0' r='10' gradientTransform='matrix(6.4343e-14 3.4086 -12.286 1.8923e-13 50.5 -7.776e-13)'><stop stop-color='rgba(229,234,250,0.2)' offset='0'/><stop stop-color='rgba(229,234,250,0)' offset='0.3'/><stop stop-color='rgba(7,13,24,0)' offset='0.6'/><stop stop-color='rgba(7,13,24,0.5)' offset='1'/></radialGradient></defs></svg>\"), linear-gradient(90deg, rgb(14, 25, 45) 0%, rgb(14, 25, 45) 100%)" }} data-name="Tabs New - Sports">
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] min-w-px not-italic relative text-[#acafbb] text-[14px] text-center whitespace-normal">
          <p className="leading-[18px]">Top League (45)</p>
        </div>
      </div>
